...
shader_wrapper Components::geometry_shader("g_buffer.vs", "g_buffer.fs");
shader_wrapper Components::lighting_shader("deferred_shading.vs", "deffered_shading.fs");
shader_wrapper Components::light_cube_shader("defered_light_box.vs", "deferred_light_box.fs");
...
void Components::init() {
	...
	cam.set_fov(glm::radians(45.0f));
	cam.set_ratio((GLfloat)1800 / (GLfloat)1600);
	cam.set_near(0.1f);
	cam.set_far(100.0f);
